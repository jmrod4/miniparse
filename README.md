...
You can also find a nice [documentation from the current version](http://jmrod4.github.io/miniparse/Miniparse/Parser.html)
at the [Miniparse web site](http://jmrod4.github.io/miniparse/) 
...
There is [a FAQ available](http://jmrod4.github.io/miniparse/file.FAQ.html). 
...
This library is copyrighted software and it can be used and distributed as open source under the terms of the [MIT License](http://jmrod4.github.io/miniparse/file.LICENSE.html) (as featured on [opensource.org](http://opensource.org/licenses/MIT)).
